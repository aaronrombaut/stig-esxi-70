...
foreach ($myVM in $myVMS) {
    ...
    # Check text
    Get-VM -Name $myVM | Where-Object {$_.ExtensionData.Config.Hardware.Device.DeviceInfo.Label -match "usb"}
    Get-VM -Name $myVM | Get-UsbDevice
    
    # Fix text
#    Get-VM -Name $myVM | Get-USBDevice | Remove-USBDevice
}